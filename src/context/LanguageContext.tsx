...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "edu.magister": { EN: "Magister – Advanced Management Program (PAG)", ES: "Magíster – "edu.magister": { EN: "Magister – Advanced Management Program (PAG)", ES: "Magíster – Programa Avanzado de Gerencia (PAG)" }," },
  ...
  "fexp.1.b1": { EN: "Administered contract amendments, including COVID-related adjustments", ES: "Administré modificaciones contractuales, "fexp.1.b1": { EN: "Administered contract amendments, including COVID-related adjustments", ES: "Administré modificaciones contractuales, incluyendo ajustes relacionados con el COVID-19" }," },
  "fexp.1.b2": { EN: "fexp.1.b2": { EN: "Managed & Executed **$24M** in performance and advance payment bonds", ES: "Gestioné y ejecuté USD **$24 millones** en fianzas de cumplimiento y anticipos" },, ES: "Gestioné y ejecuté USD **$24 millones** en fianzas de cumplimiento y anticipos" },
